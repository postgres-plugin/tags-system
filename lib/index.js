...
var fs = require('fs');
var file = path.resolve(__dirname, 'fixtures/create-tables.sql');
var fixtures = fs.readFileSync(file, 'utf8').toString();
var tagsContent = require('./fixtures/tags-data.js');
var categoriesContent = require('./fixtures/categories-data.js');
var tagsCatContent = require('./fixtures/tags-categories-data.js');
