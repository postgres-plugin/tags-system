...
module.exports.register = function (server, options, next) {
  ...
  query(initialiseQuery, pool, function (error) {
    ...
    server.ext('onPreHandler', function (request, reply) {
      ...
      request.pg.tags.getChallengesByTag = function (id, cb) {
        return query(queries.getChallengesByTag(id), pool, cb);
      };
      ...
      request.pg.tags.getTagsForEdit = function (tableName, itemId, cb) {
        var result = {};
